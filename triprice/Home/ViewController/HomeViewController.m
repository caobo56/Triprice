...
//    [bottomView.mineBtn addTarget:self action:@selector(mineBtnPress) forControlEvents:UIControlEventTouchUpInside];
...
-(void)postDemandBtnPress{
    TPPushDemandViewController * pushVC = [[TPPushDemandViewController alloc]init];
    [TabVC bottomView].hidden = YES;
